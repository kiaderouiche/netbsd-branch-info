...
with open('netbsd.csv', mode='w') as netbsd_f:
    ...
    #version,branch,series, created,release,eol
    netbsd_writer.writerow(['version', 'branch', 'series', 'release', 'eol'])
    netbsd_writer.writerow(['0.8', 'netbsd-0', 'major', '20-05-1993', 'death'])
    netbsd_writer.writerow(['0.9', 'netbsd-0', 'major', '23-08-1993', 'death'])
    netbsd_writer.writerow(['1.0', 'netbsd-1', 'major', '26-10-1993', 'death'])
    netbsd_writer.writerow(['1.2.1', 'netbsd-1.2', 'minor', '20-05-1997', 'minor'])
    netbsd_writer.writerow(['2.0.1', 'netbsd-2', 'minor', '20-05-1997', ''])
    netbsd_writer.writerow(['2.1', 'netbsd-2.1', 'major', '02-11-2005', ''])
    ...
    netbsd_writer.writerow(['7.1.1', 'netbsd-7.1', 'minor', '02-11-2005', '21-08-2008'])
    netbsd_writer.writerow(['9.0', 'netbsd-9', 'major', '14-02-2020', ''])
    netbsd_writer.writerow(['9.1', 'netbsd-9', 'minor', '18-10-2020', ''])
