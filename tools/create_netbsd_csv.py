...
with open('netbsd.csv', mode='w') as netbsd_f:
    ...
    netbsd_writer.writerow(['version', 'branch','codename', 'series', 'created', 'release', 'eor'])
    netbsd_writer.writerow(['0.8', 'netbsd-0', 'stable', '', '20-05-1993', 'major', 'death'])
    netbsd_writer.writerow(['0.9', 'netbsd-0', 'stable', '', '23-08-1993', 'major', 'death'])
    netbsd_writer.writerow(['1.0', 'netbsd-1', 'stable', '', '26-10-1993', 'major', 'death'])
    netbsd_writer.writerow(['1.2.1', 'netbsd-1.2', 'security', '', '20-05-1997', 'minor', ''])
