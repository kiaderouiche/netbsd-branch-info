...
with open('netbsd.csv', mode='w') as netbsd_f:
    ...
    netbsd_writer.writerow(['1.5', 'netbsd-1.3', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.5.1', 'netbsd-1.3', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.5.2', 'netbsd-1.3', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.5.3', 'netbsd-1.3', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.6', 'netbsd-1.6', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.6.1', 'netbsd-1.6-1', 'minor','', '09-03-1998', ''])
    netbsd_writer.writerow(['1.6.2', 'netbsd-1.6-2', 'minor','', '09-03-1998', ''])
    ...
    netbsd_writer.writerow(['6.1.5', 'netbsd-6.1', 'minor', '', '22-09-2014', ''])
