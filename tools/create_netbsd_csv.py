...
with open('netbsd.csv', mode='w') as netbsd_f:
    ...
    netbsd_writer.writerow(['version', 'branch', 'series', 'created', 'release', 'end of life'])
    ...
    netbsd_writer.writerow(['2.0', 'netbsd-2', 'minor', '', '09-12-2004', '30-04-2008'])
    netbsd_writer.writerow(['2.0.2', 'netbsd-2', 'minor', '', '14-04-2005', '30-04-2008'])
    netbsd_writer.writerow(['2.0.3', 'netbsd-2', 'minor', '', '31-09-2005', '30-04-2008'])
    netbsd_writer.writerow(['2.1', 'netbsd-2.1', 'minor', '', '02-11-2005', '21-08-2008'])
    netbsd_writer.writerow(['3.0', 'netbsd-3', 'major', '', '23-12-2005', ''])
    ...
    netbsd_writer.writerow(['4.0', 'netbsd-4', 'major', '', '19-12-2007', '17-11-2012'])
    netbsd_writer.writerow(['4.0.1', 'netbsd-4', 'minor', '', '14-10-2008', '17-11-2012'])
    netbsd_writer.writerow(['5.0', 'netbsd-5', 'major', '', '14-10-2009', '09-11-2015'])
    netbsd_writer.writerow(['5.0.1', 'netbsd-5', 'minor', '', '02-08-2009', ''])
    netbsd_writer.writerow(['5.0.2', 'netbsd-5', 'minor', '', '12-02-2010', ''])
    netbsd_writer.writerow(['5.1', 'netbsd-5.1', 'minor', '', '12-11-2010','09-11-2015'])
    netbsd_writer.writerow(['5.1.2', 'netbsd-5.1', 'minor', '', '02-02-2012','09-11-2015'])
    netbsd_writer.writerow(['5.1.3', 'netbsd-5.1', 'minor', '', '28-09-2013','09-11-2015'])
    netbsd_writer.writerow(['5.1.4', 'netbsd-5.1', 'minor', '', '28-09-2013','09-11-2015'])
    netbsd_writer.writerow(['5.1.5', 'netbsd-5.1', 'minor', '', '15-11-2014','09-11-2015'])
    netbsd_writer.writerow(['5.2', 'netbsd-5.2', 'minor', '', '03-12-2012','09-11-2015'])
    netbsd_writer.writerow(['5.2.1', 'netbsd-5.2', 'minor', '', '','09-11-2015'])
    netbsd_writer.writerow(['5.2.2', 'netbsd-5.2', 'minor', '', '','09-11-2015'])
    ...
    netbsd_writer.writerow(['6.0.2', 'netbsd-6', 'minor', '', '18-05-2013',''])
    netbsd_writer.writerow(['6.0.3', 'netbsd-6', 'minor', '', '',''])
    netbsd_writer.writerow(['6.0.4', 'netbsd-6', 'minor', '', '',''])
    netbsd_writer.writerow(['6.0.5', 'netbsd-6', 'minor', '', '',''])
    netbsd_writer.writerow(['6.0.6', 'netbsd-6', 'minor', '', '22-09-2014',''])
    netbsd_writer.writerow(['6.1', 'netbsd-6.1', 'minor', '', '18-05-2013', ''])
    netbsd_writer.writerow(['6.1.1', 'netbsd-6.1', 'minor','', '22-08-2013', ''])
    netbsd_writer.writerow(['6.1.2', 'netbsd-6.1', 'minor', '', '', ''])
    netbsd_writer.writerow(['6.1.3', 'netbsd-6.1', 'minor', '', '', ''])
    ...
    netbsd_writer.writerow(['N.99.M', 'NetBSD-current', 'current', '', '', ''])
