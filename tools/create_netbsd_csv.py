...
with open('netbsd.csv', mode='w') as netbsd_f:
    ...
    netbsd_writer.writerow(['5.0', 'netbsd-5', 'major', '', '14-10-2009', ''])
    ...
    netbsd_writer.writerow(['5.1.4', 'netbsd-5.1', 'minor', '', '28-09-2013',''])
    netbsd_writer.writerow(['5.1.5', 'netbsd-5.1', 'minor', '', '15-11-2014',''])
    netbsd_writer.writerow(['5.2', 'netbsd-5.2', 'minor', '', '03-12-2012',''])
    netbsd_writer.writerow(['5.2.1', 'netbsd-5.2', 'minor', '', '',''])
    netbsd_writer.writerow(['5.2.2', 'netbsd-5.2', 'minor', '', '',''])
